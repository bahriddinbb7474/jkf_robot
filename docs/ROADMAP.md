...
Each stage requires explicit approval before work starts.
...
4. **Stage 3 - Enemies and boss (completed and pushed):** basic/fast/shooter waves and one boss.
...
7. **Stage 6 - Shop (completed locally; pending approved push):** spend rewards on permanent parts.
8. **Stage 7 - Missions:** mission selection, progression, rewards.

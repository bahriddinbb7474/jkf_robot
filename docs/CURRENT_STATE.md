...
- Available now: player creation, persisted player list, player selection, mission selection, mission-gated battles, victory/defeat reward screen, optional post-victory bonus questions, saved answer statistics and rewards, mission completion, next mission unlocks, part unlocks, shop navigation, permanent part purchases, garage navigation, owned part selection, saved robot build, stat preview, bounded WASD movement, mouse aim, three weapons, mission-driven waves, mission boss, enemy projectiles, multi-target damage, contact separation/damage, player/enemy/boss HP HUD, victory/defeat, and R restart.
...
- `BonusQuestionScene` is available only from a victory RewardScene, loads one of 30 static math/English questions, accepts one of four answers, shows the result, and returns to Missions.
